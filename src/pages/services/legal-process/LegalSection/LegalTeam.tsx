...
import thrishan from "../../../../assets/Trishan.jpg"
...
const OurTeam = () => {
  ...
  const operationsMembers = [
    ...
    // {
    //   name: "Dulaj Dilshan",
    //   position: "Assistant Manager - Legal Process Outsourcing",
    //   image: dulaj,
    // },
    {
        ...
        {/* {activeTab === "Leadership" && (
          <div className="team-rows">
            ...
            <div className="team-row">
              ...
              <TeamCard name="Suren Perera" position="Manager - Administration" image={member6} />
            </div>
          </div>
        )} */}
...
<TeamCard
          ...
          {/* Row 5 */}
          {/* <div className="team-row">
              <TeamCard name="Mishayel Viranjith" position="Team Leader - Contact Centre Outsourcing" image={mishayel} />
